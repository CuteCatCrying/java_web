...
try{
	...
	String data = "SELECT * FROM mahasiswa";
	rs = stmt.executeQuery(data);
			...
			<table border="1" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<td><%=rs.getString("angkatan")%></td>
					<td><a href="update.jsp?u=<%=rs.getString("nim")%>">edit</a> / <a href="delete.jsp?d=<%=rs.getString("nim")%>">hapus</a></td>
				</tr>
				<% } %>
			</table>
			<%
